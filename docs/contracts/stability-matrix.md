...
| 2 | P0 | [Project directory](./project-directory.md) | Project repository, data, files, runtime, and generated paths | Policy only | `src/platform/adapters/file/mod.rs`, project services | Review | The tree is drafted: repo/ and files/ are authored, data/ splits into store, cache, recovery, and logs; apply the reclassification to the code and migrate existing instances |
