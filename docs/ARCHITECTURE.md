...
- [OFFICE_FEDERATION_MODEL.md](/path/to/zebflow/docs/OFFICE_FEDERATION_MODEL.md)
...
- `musicsite.example` is likely `dedicated`
- `community.example` may start `shared` and later graduate
- `example.com` may remain `shared`
