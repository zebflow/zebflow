...
pub fn definition() -> NodeDefinition {
    NodeDefinition {
        ...
        dsl_flags: vec![
            ...
            DslFlag {
                flag: "--where-value-path".to_string(),
                config_key: "where_value_path".to_string(),
                description: "Dot-notation path into input payload for the filter value (query).".to_string(),
                kind: DslFlagKind::Scalar,
                required: false,
            },
            DslFlag {
            ...
            DslFlag {
                flag: "--data-path".to_string(),
                config_key: "data_path".to_string(),
                description: "Dot-notation path into input payload for upsert row data (default: full input).".to_string(),
                kind: DslFlagKind::Scalar,
                required: false,
            },
            DslFlag {
                flag: "--data-expr".to_string(),
                config_key: "data_expr".to_string(),
                description: "JS expression returning the upsert row data object.".to_string(),
                kind: DslFlagKind::Scalar,
                required: false,
            },
            DslFlag {
                ...
                description: "JS expression returning the row ID string for upsert.".to_string(),
                kind: DslFlagKind::Scalar,
                required: false,
            },
            DslFlag {
                flag: "--table-expr".to_string(),
                config_key: "table_expr".to_string(),
                description: "JS expression returning the table name at runtime.".to_string(),
                kind: DslFlagKind::Scalar,
                required: false,
            },
            DslFlag {
                flag: "--where-field-expr".to_string(),
                config_key: "where_field_expr".to_string(),
                description: "JS expression returning the filter field name at runtime.".to_string(),
                kind: DslFlagKind::Scalar,
                required: false,
            },
            DslFlag {
                flag: "--limit-expr".to_string(),
                config_key: "limit_expr".to_string(),
                description: "JS expression returning the row limit integer at runtime.".to_string(),
                kind: DslFlagKind::Scalar,
                required: false,
            },
        ],
        ...
        ai_tool: crate::pipeline::model::NodeAiToolDefinition {
            ...
            tool_description: "Query the embedded Sekejap table store using SekejapQL. Args: query (required).".to_string(),
            tool_input_schema: serde_json::json!({
                "type": "object",
                "properties": {
                    "query": { "type": "string", "description": "SekejapQL query string" }
                },
                "required": ["query"]
            }),
        },
