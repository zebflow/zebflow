...
mod tests {
    ...
    fn output_path_stays_scoped() {
        ...
        assert_eq!(rel, "private/static/musicsite/artists/a/song.html");
    }
...
"#,
        ...
        assert_eq!(
            ...
            "private/static/musicsite/artists/iwan-fals/bento/lyric.html"
        );
        assert_eq!(
            first.value["generated"]["url"],
            "/files/superadmin/example-project/private/static/musicsite/artists/iwan-fals/bento/lyric.html"
        );
        assert_eq!(
            first.value["generated"]["site_root"],
            "private/static/musicsite"
        );
        assert_eq!(
            first.value["generated"]["manifest_path"],
            "private/static/musicsite/.zebflow-static-site.json"
        );
        ...
        .expect("manifest");
        assert!(manifest.contains("\"site_root\": \"private/static/musicsite\""));
...
"#,
        ...
        assert_eq!(
            ...
            "private/static/musicsite/a/aurora/songs/runaway/lyrics/index.html"
        );
