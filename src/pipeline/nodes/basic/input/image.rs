//! `n.input.image` — one image FileRef at `files.<name>` — `input.file` with `--accept` preset to `image`.
//!
...
pub const NODE_KIND: &str = "n.input.image";

pub fn definition() -> NodeDefinition {
    super::definition_for(super::InputKind::Image)
}
