...
mod tests {
    ...
    fn init_and_add_office_updates_management_and_auto_update() {
        ...
        assert!(
            auto_update.contains("value: \"statefulset/office-main,statefulset/office-a\"")
                || auto_update.contains("value: \"statefulset/office-a,statefulset/office-main\"")
        );
    }
