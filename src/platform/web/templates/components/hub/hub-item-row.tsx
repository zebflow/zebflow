  ...
  return (
    <button
      ...
      className={cx(
        ...
        selected ? "bg-ui-bg-muted" : "hover:bg-ui-bg-muted/50",
      )}
    >
      ...
      <span className="min-w-0 flex-1">
        <span className="flex items-center gap-2">
          <span className="truncate text-[0.82rem] font-medium text-body">
          ...
          <span
            className={cx(
              ...
              verb === "install"
                ? "bg-ui-bg-muted text-body-soft"
                : "bg-dark-accent4/15 text-dark-accent4",
            )}
            title={
              verb === "install"
        ...
        <span className="mt-0.5 block truncate text-[0.72rem] text-body-soft">
