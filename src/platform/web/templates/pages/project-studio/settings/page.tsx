...
function GitPanel({ remoteApi, initialConfig, healthApi, repairApi }) {
...
function GitHealthPanel({ healthApi, repairApi }) {
...
function FilesPanel({ backend, backendLabel, declared, field }) {
            ...
            <div className="flex min-h-full flex-col">
              ...
              {tabFlags?.files ? (
                <section className="project-content-section">
                  <div className="project-content-body">
                    <FilesPanel
                      backend={input?.files?.backend}
                      backendLabel={input?.files?.backend_label}
                      declared={Boolean(input?.files?.declared)}
                      field={input?.files?.field}
                    />
                  </div>
                </section>
              ) : null}
