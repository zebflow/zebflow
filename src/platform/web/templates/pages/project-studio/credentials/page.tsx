    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        <Field label="Voice Label" description="Optional human label for this voice preset.">
          <Input value={s("voice")} onInput={(e:any)=>onChange("voice", e.target.value)} placeholder="narrator" />
        </Field>
        <Field label="Model File" className="col-span-2" description="Private-relative ONNX model path. Example: voices/narrator/narrator.onnx">
          <Input value={s("model_file")} onInput={(e:any)=>onChange("model_file", e.target.value)} placeholder="voices/narrator/narrator.onnx" />
        </Field>
        <Field label="Config File" className="col-span-2" description="Private-relative Piper JSON config path. Example: voices/narrator/narrator.onnx.json">
          <Input value={s("config_file")} onInput={(e:any)=>onChange("config_file", e.target.value)} placeholder="voices/narrator/narrator.onnx.json" />
        </Field>
