  ...
  return (
    ...
    >
      ...
      >
        ...
        {count === 0 && (connected || synced) && (
          <span className="absolute bottom-0 right-0 w-[7px] h-[7px] bg-green-500 pointer-events-none" />
        )}
      </button>
              ...
              <div className="flex items-center gap-2 text-[0.7rem] text-body-soft">
                ...
                <span
                  className={cx(
                    ...
                    synced && count === 0 ? "bg-green-500" : "bg-gray-500",
                  )}
                  tw-variants="bg-green-500 bg-gray-500"
                />
