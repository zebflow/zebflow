...
export function AutoOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-[99998] cursor-not-allowed bg-transparent">
      ...
      <div
        className="pointer-events-none fixed left-1/2 top-1/2 z-[99999] h-11 w-11 -translate-x-1/2 -translate-y-1/2 rounded-full border-[3px] border-[rgba(255,255,255,0.08)] border-t-info"
