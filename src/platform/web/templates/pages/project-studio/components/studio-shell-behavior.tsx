import { registerShortcut, initKeyboardShortcuts } from "@/pages/project-studio/components/keyboard-shortcuts";
import { notifyConsoleOpen, notifyConsoleClose } from "@/pages/project-studio/components/studio-chrome-bridge";
...
function toggleConsole() {
  ...
  if (consolePanel?.getAttribute("aria-hidden") === "false") {
    closeConsole();
  } else {
    openConsole();
  }
 ...
 * All visible elements are rendered by AutoOverlay (Preact in pages/project-studio/components/).
 */
