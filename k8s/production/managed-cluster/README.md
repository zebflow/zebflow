...
```bash
zebflow k8s cluster init ./my-cluster
zebflow k8s cluster add-office ./my-cluster office-a
zebflow k8s cluster set-image ./my-cluster zebflow/zebflow:0.2.0.202604120235
zebflow k8s cluster enable-auto-update ./my-cluster
zebflow k8s cluster describe ./my-cluster
zebflow k8s cluster validate ./my-cluster
```
